...
function showStaticPoster(header) {
  ...
  canvasContainer.setAttribute('aria-hidden', 'true'); // decorative visual only
  ...
  canvasContainer.style.color = 'var(--hero-col, #0066CC)';
  canvasContainer.style.backgroundImage =
    'radial-gradient(circle at center, transparent 0%, var(--page-col, #FBFBFD) 75%), ' +
